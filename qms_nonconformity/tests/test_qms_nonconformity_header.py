...
class TestNonconformityHeader(TransactionCase):
    ...
    def test_disposition_tracked(self):
        scrap = self.env.ref("qms_nonconformity.disposition_scrap")
        nonconformity = self.model.create(self._values())
        self.assertFalse(nonconformity.disposition_id)
        ...
        nonconformity.disposition_id = scrap
        self.assertEqual(nonconformity.disposition_id.code, "scrap")
